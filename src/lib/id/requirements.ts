...
export function deriveRequirements(project: IdProject): AutoRequirement[] {
  ...
  items.push(
    ...
    auto(
      ...
      "An enabling outcome supports the terminal outcome",
      "recommended",
      hasEnabling,
    ),
    auto(
      "design",
      "objective.quality",
      "Every outcome is measurable (no hollow verbs)",
      "required",
  ...
  items.push(
    ...
    auto(
      "content_development",
      "delivery.mismatch",
      "Delivery channel matches each objective's Bloom level",
      "recommended",
    ...
    auto(
      ...
      "Every objective's lesson has a guided-practice activity",
      "required",
  ...
  items.push(
    ...
    auto(
      "assessment",
      "alignment.bloom",
      "Assessment Bloom level matches its objective",
      "required",
    ...
    auto(
      "assessment",
      "tutor.evidence",
      "Apply+ objectives don't rely on chat alone as evidence",
      "required",
      !open("tutor.evidence"),
    ),
    auto(
      ...
      "Apply+ objectives have a real artifact channel selected",
      "required",
  ...
  items.push(
    auto(
      ...
      "No blocking filter findings remain open",
      "required",
      !openBlocking,
    ),
    auto(
